...
import { RefreshCw, Menu, CheckCircle2, AlertCircle, Sun, Moon } from 'lucide-react';
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-3.5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-lg sm:text-xl font-bold tracking-tight text-neutral-900 dark:text-neutral-100">
                SAS Bulletin <span className="font-semibold text-blue-600 dark:text-blue-400">Task Monitor</span>
              </h1>
            </div>
        ...
        <div className="flex items-center justify-between sm:justify-end gap-3 shrink-0">
          ...
          {toggleDarkMode && (
            ...
            >
              {isDark ? <Sun size={15} className="text-amber-400" /> : <Moon size={15} className="text-neutral-600" />}
            </button>
          )}
